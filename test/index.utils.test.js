import { ordinalSuffixOf, getCurrentDateLocalTime, goalEmojis, thumbsDownEmojis, starEmojis, convertdescKeyToWords, convertUTCToLocalTime, getLastName, groupedList, splitArray, sleep, formatPeriodLabel, formatPeriodTime, transformGameLandingToLineScores, } from "../src/utils";
const runWithFakeTimers = async (testFn, options) => {
...
describe("src/utils", () => {
    ...
    test("convertUTCToLocalTime converts to supplied timezone", () => {
        const result = convertUTCToLocalTime("2024-01-15T15:00:00Z", "America/New_York");
