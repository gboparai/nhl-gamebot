 ...
 */
export async function addImageAsBackground(
 ...
 */
export function addSquareWithGoals(
  ctx: CanvasRenderingContext2D,
  options: TransparentSquareOptions,
): void {
  const { x, y, width, height, transparency, lineItems, xPadding, yPadding } =
    options;
 ...
 */
export function addRotatedText(
  ctx: CanvasRenderingContext2D,
  options: RotatedTextOptions,
): void {
 ...
 */
export async function addTeamLogo(
  ctx: CanvasRenderingContext2D,
 ...
 */
export function drawStackedHorizontalBarGraph(
  ctx: CanvasRenderingContext2D,
