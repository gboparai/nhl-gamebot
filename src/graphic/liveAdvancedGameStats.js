...
import { addText, addImageAsBackground, saveCanvasImage, loadCustomFont, drawStackedHorizontalBarGraph, calculatePercentage, getTeamColor, } from "./utils";
function metricLabel(value, decimals = 0) {
    return value.toFixed(decimals);
}
export default async function createLiveAdvancedGameStatsImage(params) {
    ...
    const makeBar = (overallLabel, homeValue, awayValue, decimals = 0) => ({
        overallLabel,
        segments: [
            {
