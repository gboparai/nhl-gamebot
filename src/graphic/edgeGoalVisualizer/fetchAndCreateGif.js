...
import { createTrackingGif } from "./createTrackingGif";
/**
 ...
 */
export async function fetchAndCreateGif(params) {
    ...
    try {
        ...
        await createTrackingGif({
            ...
            leftTeam,
            rightTeam,
        }, trackingData, outputPath, options);
 ...
 */
export function parseTrackingUrl(url) {
