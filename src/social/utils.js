 ...
 */
export async function convertGifToMp4(gifPath, outputPath) {
 ...
 */
export async function retryOperation(operation, retries = 3, delay = 5000, context, content) {
    try {
 ...
 */
export function generateGameHashtags(game, teamHashtagFunction, format = "twitter") {
 ...
 */
export function validateMediaPaths(media) {
    const fs = require('fs');
 ...
 */
export function teamHashtag(team) {
