 ...
 */
export function setDateOverride(date) {
    dateOverride = date;
}
/**
 ...
 */
export function getCurrentDateLocalTime(timeZone) {
 ...
 */
export function goalEmojis(num) {
    let emojis = "";
    for (let i = 0; i < num; i++) {
        emojis += "🚨";
    }
 ...
 */
export function thumbsDownEmojis(num) {
    let emojis = "";
    for (let i = 0; i < num; i++) {
        emojis += "👎🏻";
    }
 ...
 */
export function starEmojis(num) {
    let emojis = "";
    for (let i = 0; i < num; i++) {
        emojis += "⭐️";
    }
 ...
 */
export function convertdescKeyToWords(str) {
 ...
 */
export function convertUTCToLocalTime(utcDateTimeString, timeZone) {
 ...
 */
export function groupedList(arr, length) {
 ...
 */
export function formatPeriodLabel(period, gameType) {
    if (period === 1)
        return "1st";
    if (period === 2)
        return "2nd";
 ...
 */
export function formatPeriodTime(period, rawTime, gameType) {
 ...
 */
export function transformGameLandingToLineScores(gameLanding) {
 ...
 */
function getGoalType(situationCode) {
